...
export async function mountLayout(appUser, activeKey) {
  ...
  sidebar.innerHTML = `
    <div class="sidebar__brand">
      <img src="https://www.sirfisher.com.br/assets/img/logo-icon.png" alt="" class="sidebar__brand-logo" width="536" height="528" />
  ...
  document.body.innerHTML = `
    <div class="login-screen">
      <div class="login-card">
        <img src="https://www.sirfisher.com.br/assets/img/logo-emblem.png" alt="" class="login-card__logo" width="654" height="700" />
        <h1>Acesso negado</h1>
        <p>${message}</p>
