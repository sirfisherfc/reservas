...
--
-- Escolhi pg_cron a cada 5 minutos em vez de um webhook em INSERT porque:
--   - cobre os tres providers de uma vez;
--   - reprocessa sozinho o que falhou, sem depender de um novo INSERT;
--   - nao tem corrida entre o commit da transacao e a chamada HTTP.
--
